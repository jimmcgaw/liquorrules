...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'DrinkLink', fields ['href']
        db.create_index('booze_drinklink', ['href'])

        # Adding index on 'DrinkLink', fields ['name']
        db.create_index('booze_drinklink', ['name'])


    def backwards(self, orm):
        
        # Removing index on 'DrinkLink', fields ['name']
        db.delete_index('booze_drinklink', ['name'])

        # Removing index on 'DrinkLink', fields ['href']
        db.delete_index('booze_drinklink', ['href'])
